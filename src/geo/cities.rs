...
//!
//! **Provenance: undocumented.** Unlike `data::sites` (NOAA/NCEI NEXRAD
//! Stations feature service) and the alert zone geometry (regenerated by
//! `tools/build_zone_geometry.py`), this table was hand-entered and no source
//! is recorded. Treat the coordinates and population tiers as approximate
//! display data, not authoritative. Anyone needing to correct or extend it
