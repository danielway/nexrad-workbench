...
pub(crate) mod ui {
    ...
    pub(crate) fn label(dark: bool) -> Color32 {
        if dark {
    ...
    pub(crate) fn value(dark: bool) -> Color32 {
        if dark {
    ...
    pub(crate) const ACTIVE: Color32 = Color32::from_rgb(100, 180, 255);
    /// Success/positive indicator (theme-independent).
    pub(crate) const SUCCESS: Color32 = Color32::from_rgb(100, 200, 100);
}
...
pub(crate) mod mode {
    ...
    pub(crate) const IDLE: Color32 = Color32::from_rgb(100, 100, 100);
    /// Archive - data loaded and under cursor.
    pub(crate) const ARCHIVE: Color32 = Color32::from_rgb(100, 180, 255);
    /// Live - real-time streaming locked to now.
    pub(crate) const LIVE: Color32 = Color32::from_rgb(255, 80, 80);

    /// Shell-side mapping from the derived [`AppMode`](crate::state::AppMode)
    /// to its accent color (the core stays color-free).
    pub(crate) fn color(mode: crate::state::AppMode) -> Color32 {
        match mode {
...
pub(crate) mod timeline {
    ...
    pub(crate) fn background(dark: bool) -> Color32 {
        if dark {
    ...
    pub(crate) fn tick_major(dark: bool) -> Color32 {
        if dark {
    ...
    pub(crate) fn tick_minor(dark: bool) -> Color32 {
        if dark {
            Color32::from_rgb(60, 60, 80)
        } else {
    ...
    pub(crate) fn tick_label(dark: bool) -> Color32 {
        if dark {
    ...
    pub(crate) fn selection(dark: bool) -> Color32 {
        if dark {
    ...
    pub(crate) const ACTIVE_SWEEP: Color32 = Color32::from_rgb(255, 255, 100);
    ...
    pub(crate) const PREV_ACTIVE_SWEEP: Color32 =
        Color32::from_rgba_premultiplied(110, 110, 43, 110);
    ...
    pub(crate) const NOW_IDLE: Color32 = Color32::from_rgb(200, 95, 95);
    /// Live status color for the now-line / "LIVE" cap when streaming —
    /// the bright, active end of the same red.
    pub(crate) const LIVE_ACTIVE: Color32 = Color32::from_rgb(255, 80, 80);
    ...
    pub(crate) const SELECTION_LABEL: Color32 = Color32::from_rgb(180, 188, 205);
    ...
    pub(crate) fn selection_edge() -> Color32 {
    ...
    pub(crate) fn cached_fill(dark: bool, partial: bool) -> Color32 {
    ...
    pub(crate) fn available_fill(dark: bool) -> Color32 {
    ...
    pub(crate) fn available_border(dark: bool) -> Color32 {
        let (r, g, b) = if dark { AVAILABLE_RGB } else { (90, 110, 150) };
    ...
    pub(crate) fn container_border(dark: bool) -> Color32 {
        if dark {
    ...
    pub(crate) fn sub_texture(dark: bool) -> Color32 {
        if dark {
...
pub(crate) mod canvas {
    ...
    pub(crate) fn center_marker(dark: bool) -> Color32 {
        if dark {
    ...
    pub(crate) fn center_marker_stroke(dark: bool) -> Color32 {
        if dark {
    ...
    pub(crate) fn ring(dark: bool) -> Color32 {
        if dark {
    ...
    pub(crate) fn ring_major(dark: bool) -> Color32 {
        if dark {
    ...
    pub(crate) fn radial(dark: bool) -> Color32 {
        if dark {
    ...
    pub(crate) fn cardinal_label(dark: bool) -> Color32 {
        if dark {
...
pub(crate) mod acquisition {
    ...
    pub(crate) const QUEUED: Color32 = Color32::from_rgb(120, 160, 200);
    /// Active operation — bright blue.
    pub(crate) const ACTIVE: Color32 = Color32::from_rgb(100, 180, 255);
    /// Completed operation — green.
    pub(crate) const COMPLETED: Color32 = Color32::from_rgb(100, 200, 100);
    /// Failed operation — red.
    pub(crate) const FAILED: Color32 = Color32::from_rgb(255, 100, 100);
    /// Cancelled operation — gray.
    pub(crate) const CANCELLED: Color32 = Color32::from_rgb(120, 120, 120);
}
...
pub(crate) mod mping {
    ...
    /// background.
    pub(crate) const STROKE: Color32 = Color32::from_rgb(20, 20, 25);

    /// Fill color for a report's marker, by category.
    pub(crate) fn fill(category: ReportCategory) -> Color32 {
        match category {
...
pub(crate) mod sites {
    ...
    pub(crate) const OTHER: Color32 = Color32::from_rgb(255, 180, 80);
    /// Orange stroke for other sites.
    pub(crate) const OTHER_STROKE: Color32 = Color32::from_rgb(180, 120, 40);
    /// Cyan for current site.
    pub(crate) const CURRENT: Color32 = Color32::from_rgb(50, 200, 255);
    /// Cyan stroke for current site.
    pub(crate) const CURRENT_STROKE: Color32 = Color32::from_rgb(30, 150, 200);
    /// Label color for other sites.
    pub(crate) const LABEL: Color32 = Color32::from_rgb(220, 220, 240);
    /// Label color for current site.
    pub(crate) const CURRENT_LABEL: Color32 = Color32::from_rgb(50, 200, 255);
}
