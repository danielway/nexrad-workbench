...
impl UserPreferences {
    ...
    pub fn from_app_state(state: &AppState) -> Self {
        Self {
            ...
            layer_nws_alerts: state.layer_state.geo.nws_alerts,
    ...
    pub fn apply_to(&self, state: &mut AppState) {
        ...
        state.layer_state.geo.nws_alerts = self.layer_nws_alerts;
