...
| ID | Title | Status |
|----|-------|--------|
| S1 | Subsystem Decomposition | in progress (Acquisition + Diagnostics + Render + Live (channel only) extracted; Timeline/Playback/Chrome remain; Live still owes mode/model/app_mode) |
